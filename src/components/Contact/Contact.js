        ...
        <Row className="justify-content-center">
          ...
          <Col md={5} className="contact-info">
            ...
            <ul className="contact-details">
              <li><AiFillPhone className="contact-icon" /> +91 93061-80390</li>
              <li><AiOutlineMail className="contact-icon" /> sharmasartik@gmail.com</li>
              <li>
                <FaLinkedinIn className="contact-icon" />
                <a href="https://www.linkedin.com/in/sartik-sharma-ab2152221/" target="_blank" rel="noopener noreferrer">
                   Sartik Sharma
                </a>
              </li>
              <li>
                <FaGithub className="contact-icon" />
                <a href="https://github.com/Sartik0709" target="_blank" rel="noopener noreferrer">
                  Sartik0709
                </a>
              </li>
            </ul>
